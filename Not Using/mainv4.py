...
app.layout = html.Div([
    ...
    html.Div([  # Main Layout: Graphs and Video
        html.Div([  # Left: Graphs Column
            html.H3("Round-Trip Time (ms) Over Time", style={
                "textAlign": "center", "color": "#2c3e50", "marginBottom": "10px", "fontWeight": "bold"}),
            dcc.Graph(figure=rtt_fig, style={"marginBottom": "10px"}),

            html.H3("Throughput (Mbit/s) Over Time", style={
                "textAlign": "center", "color": "#2c3e50", "marginBottom": "10px", "fontWeight": "bold"}),
            dcc.Graph(figure=thrpt_fig, style={"marginBottom": "10px"}),

            html.H3("Packet Loss Over Time", style={
                "textAlign": "center", "color": "#2c3e50", "marginBottom": "10px", "fontWeight": "bold"}),
