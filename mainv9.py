...
demo_title = "Demo: Network Telemetry for Low Latency, Low Loss, Scalable Throughput (L4S) over Starlink Network"
...
app.layout = html.Div([
    ...
    html.Div([  # First Row: Throughput + Simulation
        html.Div([
            html.Div("Throughput (Mbps) vs Time", style=header_style),
